...
<p className="text-gray-800 mb-4">
    ...
    <h3 className="text-xl md:text-2xl font-semibold text-gray-800 mt-6 mb-3">
      बुक व्हॅल्यू विरुद्ध मार्केट व्हॅल्यू
    </h3>

    <ul className="list-disc pl-6 mb-4">
      <li className="text-gray-800">
        <strong>बुक व्हॅल्यू</strong>: शेअर्स जारी केले जातात ती प्रारंभिक किंमत.
        <p className="ml-4">उदाहरण: चायटेक प्रत्येकी ₹100 च्या 50,000 शेअर्स जारी करते, म्हणून बुक व्हॅल्यू प्रति शेअर ₹100 आहे.</p>
      </li>
      <li className="text-gray-800">
        <strong>मार्केट व्हॅल्यू</strong>: स्टॉक मार्केटमध्ये शेअर्स सध्या ज्या किंमतीला व्यापार करत आहेत ती किंमत.
        <p className="ml-4">उदाहरण: जसजसे चायटेक लोकप्रिय आणि नफा कमावणारे होते, तसतसे लोक ₹100 च्या शेअरसाठी ₹150 देण्यास तयार होऊ शकतात.</p>
      </li>
    </ul>
