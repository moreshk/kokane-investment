      ...
      <article className="prose lg:prose-xl max-w-4xl mx-auto">
        ...
        <ol className="list-decimal pl-6 mb-4">
          <li className="text-gray-800">
            <strong>Stocks</strong>: यशस्वी कंपन्यांचा एक छोटा भाग खरेदी करणे. हे अनेक वेगवेगळ्या विहिरींचा एक छोटा भाग असल्यासारखे आहे.
          </li>
          <li className="text-gray-800">
            <strong>Property</strong>: अशी स्थावर मालमत्ता खरेदी करणे जिची किंमत वाढू शकते किंवा जी भाडे निर्माण करू शकते.
          </li>
          <li className="text-gray-800">
            <strong>Commodities</strong>: सोने किंवा तेल यासारख्या मौल्यवान वस्तूंमध्ये गुंतवणूक करणे.
          </li>
        </ol>
        ...
        <ol className="list-decimal pl-6 mb-4">
          ...
          <li className="text-gray-800">महागाईमुळे (inflation) तुमचे पैसे कमी होण्यापासून संरक्षण करणे.</li>
        </ol>
